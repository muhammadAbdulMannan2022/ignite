...
const UserManagement = () => {
    ...
    return (
        <div className="min-h-[85vh] text-white bg-blue-950/10 backdrop-blur-xl shadow-2xl p-6">
            ...
            <main className="container mx-auto pb-16">
                ...
                <section className="rounded-xl border border-gray-700 bg-gray-800/20 shadow">
